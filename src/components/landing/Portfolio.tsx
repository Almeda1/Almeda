...
const projects: Project[] = [
  {
    ...
    tags: ["React.js", "Tailwind CSS", "Typescript", "+1"],
    fullTags: ["React.js", "Tailwind CSS", "Typescript", "Hosting"],
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Completed Projects</h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden rounded-2xl bg-black border border-white/5">
                <div className="absolute inset-0 bg-gradient-to-t from-[#020617]/50 to-transparent z-10" />
                <img 
                  src={project.image} 
                  alt={project.title} 
              ...
              <div className="p-4 pt-5">
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/10 border border-white/10 p-2 backdrop-blur-sm shadow-inner">
                    <img 
                      src={project.logo} 
            ...
            <div className="overflow-y-auto custom-scrollbar">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-5 mb-8 border-b border-white/5 pb-8">
                  <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-white/5 border border-white/10 p-3 backdrop-blur-sm">
                    <img 
